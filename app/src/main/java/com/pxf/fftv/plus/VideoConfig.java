...
public class VideoConfig {
    ...
    public static final Video1[] VIDEO_CONFIG_CMS = new Video1[]{
            new Video1("精选", true, false, new Video2[]{
                    new Video2("电影", "电影", BASE_CMS_URL + "&t=1"),
                    new Video2("电视", "电视", BASE_CMS_URL + "&t=2"),
                    new Video2("综艺", "综艺", BASE_CMS_URL + "&t=3"),
                    new Video2("动漫", "动漫", BASE_CMS_URL + "&t=4"),
            }),
            new Video1("电影", false, false, new Video2[]{
                    new Video2("新片上架", "最新电影", BASE_CMS_URL + "&t=1"),
            ...
            new Video1("电视剧", false, false, new Video2[]{
                    new Video2("新剧上新", "最新剧集", BASE_CMS_URL + "&t=2"),
                    new Video2("国产剧集", "国产剧集", BASE_CMS_URL + "&t=13"),
                    new Video2("香港剧集", "香港剧集", BASE_CMS_URL + "&t=14"),
                    new Video2("日本剧集", "日本剧集", BASE_CMS_URL + "&t=15"),
                    new Video2("欧美剧集", "欧美剧集", BASE_CMS_URL + "&t=16"),
                    new Video2("台湾剧集", "台湾剧集", BASE_CMS_URL + "&t=20"),
                    new Video2("韩国剧集", "韩国剧集", BASE_CMS_URL + "&t=21")
            }),
            new Video1("综艺", false, false, new Video2[]{
                    new Video2("最新综艺", "最新综艺", BASE_CMS_URL + "&t=3"),
                    new Video2("大陆综艺", "大陆综艺", BASE_CMS_URL + "&t=22"),
                    new Video2("港台综艺", "港台综艺", BASE_CMS_URL + "&t=23"),
                    new Video2("日韩综艺", "日韩综艺", BASE_CMS_URL + "&t=24"),
                    new Video2("欧美综艺", "欧美综艺", BASE_CMS_URL + "&t=25"),
                    new Video2("其他综艺", "其他综艺", BASE_CMS_URL + "&t=30")
            }),
            new Video1("动漫", false, false, new Video2[]{
                    new Video2("最新动漫", "最新动漫", BASE_CMS_URL + "&t=4"),
                    new Video2("大陆动漫", "大陆动漫", BASE_CMS_URL + "&t=26"),
                    new Video2("港台动漫", "港台动漫", BASE_CMS_URL + "&t=27"),
                    new Video2("日韩动漫", "日韩动漫", BASE_CMS_URL + "&t=28"),
                    new Video2("欧美动漫", "欧美动漫", BASE_CMS_URL + "&t=29"),
                    new Video2("其它动漫", "其它动漫", BASE_CMS_URL + "&t=31"),
            })
    };
